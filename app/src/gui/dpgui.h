...
class MainDialog : public wxDialog
{
	...
	public:
		...
		MainDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Buckshot Patcher"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 504,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxDEFAULT_DIALOG_STYLE|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER );
...
class DecodePanel : public wxPanel
{
	...
	public:
		...
		DecodePanel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 260,184 ), long style = wxTAB_TRAVERSAL, const wxString& name = wxEmptyString );
...
class EncodePanel : public wxPanel
{
	...
	public:
		...
		EncodePanel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 320,407 ), long style = wxTAB_TRAVERSAL, const wxString& name = wxEmptyString );
